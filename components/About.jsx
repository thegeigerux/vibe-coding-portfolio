...
export default function About() {
  return (
    <section id="about" className="scroll-mt-24 pt-10 pb-18 sm:scroll-mt-28 sm:pt-12 sm:pb-22">
        ...
        <div className="section-glow grid gap-10 rounded-[2rem] px-0 py-2 lg:grid-cols-[0.9fr_1.1fr]">
          ...
          <div className="grid gap-6">
            <p className="glass-panel max-w-3xl rounded-[2rem] p-6 text-base leading-relaxed text-[var(--color-muted)] sm:text-lg">
              I build modern web experiences for founders, teams, and ambitious products
              that need more than a template. My work lives where frontend systems, UX
              craft, and performance discipline overlap, so the result feels distinctive
